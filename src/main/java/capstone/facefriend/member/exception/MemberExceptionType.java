...
public enum MemberExceptionType implements ExceptionType {
    ...
    DUPLICATED_EMAIL(Status.BAD_REQUEST, 3006, "이미 사용중인 이메일입니다."),
    WRONG_PASSWORD(Status.BAD_REQUEST, 3007, "잘못된 비밀번호입니다."),
    EXPIRED_ACCESS_TOKEN(Status.BAD_REQUEST, 3008, "만료된 액세스 토큰이므로 재발급해야 합니다."),
    INVALID_ACCESS_TOKEN(Status.BAD_REQUEST, 3009, "유효하지 않은 액세스 토큰입니다."),
    INVALID_REFRESH_TOKEN(Status.BAD_REQUEST, 3010, "유효하지 않은 리프레시 토큰입니다."),
