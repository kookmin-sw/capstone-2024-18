  ...
  return (
    <div ref={childRef} id={classes.container}>
      <div style={{flexDirection: 'row', display: 'flex', marginBottom: 90}}>
        ...
        <div style={{paddingTop: 20, paddingLeft: '6%', paddingRight: '6%'}}>
      ...
      <img src={`${process.env.PUBLIC_URL}/system_architecture.png`} width={"100%"} style={{position: 'relative', margin: 0, padding:20, paddingRight: 0, backgroundColor: '#FFFFFF60',marginBottom: 90}}/>

      <text id={classes.contentTitle} style={{display: 'block'}}>4. 사용법</text>
      <div style={{columnCount: 2, paddingLeft: '20%', paddingRight: '20%', marginBottom: 90}}>
      ...
      <text id={classes.contentTitle} style={{display: 'block'}}>6. 문서(포스터, 발표 ppt)</text>
