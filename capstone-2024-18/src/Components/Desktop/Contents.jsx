    ...
    <div ref={childRef} id={classes.container}>
      ...
      <div style={{marginBottom: 90}}>
        <div style={{flexDirection:'row', display: 'flex'}}>
          ...
          <img src={`${process.env.PUBLIC_URL}/screen2.png`} width={"25%"} style={{position: 'relative', margin: 0, marginLeft: '6%', marginRight: '6%'}}/>
        </div>
        <div style={{flexDirection:'row', display: 'flex'}}>
          <img src={`${process.env.PUBLIC_URL}/screen3.png`} width={"25%"} style={{position: 'relative', margin: 0, marginLeft: '6%', marginRight: '6%'}}/>
        ...
        <div style={{flexDirection:'row', display: 'flex'}}>
          ...
          <img src={`${process.env.PUBLIC_URL}/screen4.png`} width={"25%"} style={{position: 'relative', margin: 0, marginLeft: '6%', marginRight: '6%'}}/>
        </div>
        <div style={{flexDirection:'row', display: 'flex'}}>
          <img src={`${process.env.PUBLIC_URL}/screen5.png`} width={"25%"} style={{position: 'relative', margin: 0, marginLeft: '6%', marginRight: '6%'}}/>
        ...
        <div style={{flexDirection:'row', display: 'flex'}}>
          ...
          <img src={`${process.env.PUBLIC_URL}/screen6.png`} width={"25%"} style={{position: 'relative', margin: 0, marginLeft: '6%', marginRight: '6%'}}/>
        </div>
      </div>

      <text id={classes.contentTitle} style={{display: 'block'}}>3. 서비스 구조</text>
      <img src={`${process.env.PUBLIC_URL}/system_architecture.png`} width={"100%"} style={{position: 'relative', margin: 0, backgroundColor: '#FFFFFF60', marginBottom: 90}}/>

      <text id={classes.contentTitle} style={{display: 'block'}}>4. 사용법</text>
      <div style={{columnCount: 2, paddingLeft: '25%', paddingRight: '25%', marginBottom: 90}}>
